...
ALTER TABLE users
    ADD CONSTRAINT chk_users_preferred_language CHECK (preferred_language IN ('fr', 'en')) NOT VALID;
ALTER TABLE users VALIDATE CONSTRAINT chk_users_preferred_language;
