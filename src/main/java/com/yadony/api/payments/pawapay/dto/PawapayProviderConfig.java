...
public record PawapayProviderConfig(String provider, String countryAlpha3, String currency,
    ...
    public record Limits(BigDecimal minAmount, BigDecimal maxAmount, String decimalsInAmount,
    ...
    public boolean isRedirectDeposit() { return deposit != null && PawapayProviders.isRedirect(provider, deposit.authType()); }
}
