 ...
 * 9 {@code null} pour les collaborateurs que ces deux méthodes ne touchent jamais).
 */
...
class MobileMoneyBidPaymentServiceEscrowTest {
    ...
    void setUp() {
        service = new MobileMoneyBidPaymentService(bidRepository, announcementRepository, null, paymentRepository,
                operations, submission, null, null, null, audit, events, null, null, null, null, null);
